...
public class DashboardFragment extends BaseInjectorFragment {
    ...
    public void receiveBluetoothStateChanged(BluetoothStateChangedEvent event) {
        ...
        runAfterInflation(() -> {
            if (!event.isBluetoothEnabled){
                this.bluetoothIndicator.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.cario_warning_red)));
            }
            else {
                this.bluetoothIndicator.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.cario_color_primary_dark)));
            }
    ...
    public void onReceiveNewCarTypeSelectedEvent(final NewCarTypeSelectedEvent event) {
        ...
        runAfterInflation(() -> {
            if (event.mCar != null) {
                ...
                this.carIndicator.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.cario_color_primary)));
            } else {
                // set warning indicator color to red
                this.carIndicator.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.cario_warning_red)));
            }
            this.updateStartTrackButton();
        });
    }
    ...
    public void onGpsStateChangedEvent(final GpsStateChangedEvent event) {
        ...
        runAfterInflation(() -> {
            if (!event.mIsGPSEnabled){
                this.gpsIndicator.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.cario_warning_red)));
            }
            else {
                this.gpsIndicator.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.cario_color_primary_dark)));
            }
            this.updateStartTrackButton();
        });
    }
    ...
    private void updateOBDState(BluetoothDevice device) {
        if (device != null) {
            ...
            // set indicator color
            this.obdIndicator.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.cario_color_primary_dark)));
        } else {
            this.obdIndicator.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.cario_warning_red)));
        }
        this.updateStartTrackButton();
    }
